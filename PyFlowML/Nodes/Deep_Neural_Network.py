...
class Deep_Neural_Network(NodeBase):
    def __init__(self, name):
        ...
        async def refresh_node(node):
            if node.type == 'Deep_Neural_Network':
                # Show the prompt
                await show_prompt()
        ...
        super(Deep_Neural_Network, self).__init__(name)
    ...
    def compute(self, *args, **kwargs):
        ...
        plt.savefig('metrics_tableDNN.png')
        plt.close()

        self.metrics_table.setData('metrics_tableDNN.png')
        ...
        plt.savefig('confusion_tableDNN.png')
        plt.close()

        self.confusion_table.setData('confusion_tableDNN.png')
