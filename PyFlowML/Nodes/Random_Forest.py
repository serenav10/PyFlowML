...
class Random_Forest(NodeBase):
    def __init__(self, name):
        ...
        #######################
        super(Random_Forest, self).__init__(name)
    ...
    def compute(self, *args, **kwargs):
        ...
        plt.savefig('metrics_tableRF.png')
        plt.close()

        self.metrics_table.setData('metrics_tableRF.png')
        ...
        plt.savefig('confusion_tableRF.png')
        plt.close()

        self.confusion_table.setData('confusion_tableRF.png')
