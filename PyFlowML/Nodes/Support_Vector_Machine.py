...
class Support_Vector_Machine(NodeBase):
    def __init__(self, name):
        ...
        async def refresh_node(node):
            if node.type == 'Support_Vector_Machine':
                # Show the prompt
                await show_prompt()
        ...
        super(Support_Vector_Machine, self).__init__(name)
    ...
    def compute(self, *args, **kwargs):
        ...
        plt.savefig('metrics_tableSVM.png')
        plt.close()

        self.metrics_table.setData('metrics_tableSVM.png')
        ...
        plt.savefig('confusion_tableSVM.png')
        plt.close()

        self.confusion_table.setData('confusion_tableSVM.png')
